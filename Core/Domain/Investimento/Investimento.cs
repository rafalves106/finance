...
public class Investimento
{
    ...
    public Investimento(string nome, string instituicao, TipoInvestimento tipo, decimal valorAplicado, DateTime dataInicio, TipoRentabilidade tipoRentabilidade, Liquidez liquidez, DateTime? dataVencimento = null, decimal? taxaRendimento = null)
    {
