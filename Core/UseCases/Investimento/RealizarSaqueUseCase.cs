...
{
    public void Executar(Guid investimentoId, OperacaoInvestimentoDTO dto)
    {
        ...
        var entrada = new Entrada(tituloMovimentacao, $"Valor resgatado da instituição {investimento.Instituicao}", dto.Valor, dto.Data, false, 0, null, investimento.Id);
